...
namespace MVC5App.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        //Method checks if user is registered with AWS Cognito
        //If so requests user ID from database and creates a web cookie
        [HttpPost]
        [AllowAnonymous]
        ...
        //Creates auser in cognito and an entry in the database
        [HttpPost]
        [AllowAnonymous]
